                        ...
                        <div class="row justify-content-center" style="padding: 30px;">
                            <div class="col-lg-7" style="width:800px;">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">영화 예매</h3></div>
                                    <div class="card-body">
                                        <form  action="T_buy" method="POST" enctype="multipart/form-data">

                                            <div class="row mb-3">
                                               <div class="col-md-6">
                                               <h5>예매자</h5>
                                                    <div class="form-floating mb-3 mb-md-0">
                                                     <input class="form-control" style="width:300px; padding-top:10px;" id="MId" type="text" placeholder="예매자"
                                                      name="MId"  value="${sessionScope.loginId}" >
                                                ...
                                                <h5>제목</h5>
                                                    <div class="form-floating">
                                                        <input class="form-control" style="width:330px;  padding-top:10px;" id="CTitle" type="text" placeholder="영화" name="CTitle" value="${Ticket.CTitle}" >
                                                        <input type="hidden" name="CNo" value="${Ticket.CNo}">
                                              ...
                                              <h5>날짜</h5>
                                               <div class="form-floating mb-3">
                                                <input class="form-control" style="padding-top:10px;" id="TDate" type="date" placeholder="날짜" name="TDate" />                                         
                                            </div>
                                            
                                            
                                            
                                            <fieldset class="form-group" style="height:100px;">
      <h5>시간</h5>
      <div class="form-check">
        <label class="form-check-label">
          <input type="radio" class="form-check-input" name="TTime" id="TTime" value="오전">
          오전
        </label>
      </div>
      <div class="form-check">
        <label class="form-check-label">
          <input type="radio" class="form-check-input" name="TTime" id="TTime" value="오후">
          오후
        </label>
      </div>
    </fieldset>
                                              <div class="row mb-3">
                                               	...
                                               	<h5>인원</h5>
                                                    <div class="form-floating mb-3 mb-md-0">
                                                      <input class="form-control" style="width:330px;" id=""TNum"" type="number" placeholder="인원" name="TNum" >
                                                   	  <label for="inputLastName">인원</label>  
                                                    </div>
                                                </div>         
                                            </div>     
